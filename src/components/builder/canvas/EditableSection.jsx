...
export default function EditableSection({ site, section, index, count, selected, onSelect, onMoveUp, onMoveDown, onDuplicate, onDelete, inlineEdit, moveSection }) {
